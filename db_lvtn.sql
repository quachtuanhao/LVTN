...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 30, 2024 at 08:18 AM
...
('SP06', 'Hp Elitebook 830 G9', 15000000, 100, '8GB', 'SSD 256GB', '51 Wh', 'Hp Elitebook 830 G9.jpg', 'Màn hình: 14 inch - CPU: intel Core i5-1235U - Tần số xung nhịp CPU: 3.30 GHz đến 4.40 GHz Intel® Integrated Intel® Iris® Xe Graphics  Trọng lượng: 1.2 kg', 'NSX01', 'LSP01'),
...
('SP09', 'CPU Intel Core I9 14900K', 10990000, 100, '', '', '', 'CPU Intel Core I9 14900K.png', 'Up 6.0 GHz, 24 Nhân 32 Luồng, 36MB Cache, Raptor Lake Refresh', 'NSX09', 'LSP02'),
...
('SP19', 'Miếng lót chuột nhỏ kích thước 21x26cm', 30000, 100, '', '', '', 'Miếng lót chuột nhỏ kích thước 21x26cm.jpg', 'Kiểu dáng: hình chữ nhật - Kích thước : 21x26cm - Độ dày : 0.2 cm - Chất liệu : Cao su - Bề mặt : Trơn – Nhẵn', 'NSX09', 'LSP08'),
...
('SP38', 'Màn hình Samsung LU28R550UQEXXV', 5700000, 100, '', '', '', 'Màn hình Samsung LU28R550UQEXXV.jpg', 'Loại màn hình: Phẳng - Tỉ lệ: 16:9 - Kích thước: 28 inch - Tấm nền: IPS - Độ phân giải: UHD 4K (3840 x 2160) - Tốc độ làm mới: 60Hz - Thời gian đáp ứng: 4ms - Cổng kết nối: HDMI, Display Port - Phụ kiện: Cáp nguồn, Cáp HDMI', 'NSX05', 'LSP07'),
