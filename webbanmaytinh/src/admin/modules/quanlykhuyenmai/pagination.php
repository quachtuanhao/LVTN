    ...
    <div class="pagination" style="width:600px;height:30px;margin:20px 0;display:flex;">
        ...
        <div class="" style="flex-grow: 8;">
            <div style="display: flex;flex-direction:row">
                ...
                for ($i = 1; $i <= $max; $i++) {
                ?>
                    <a href="./index.php?action=quanlykhuyenmai&query=no&page=<?php echo $i ?>" style="margin: 0 5px;height:30px;width:30px;display:flex;justify-content:center;align-items:center;cursor:pointer;border:1px solid #ccc;border-radius:4px;
