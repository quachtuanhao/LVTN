    ...
    <div class="pagination" style="width:600px;height:30px;margin:20px 0;display:flex;">
        <div class="prev" style="flex-grow: 1;">
            <?php if (isset($_GET['page']) && $_GET['page'] > 1) { ?>
                <a href="./index.php?action=quanlynhasanxuat&query=no&page=<?php echo $_GET['page'] - 1; ?>"
        ...
        <div class="" style="flex-grow: 8;">
            <div style="display: flex;flex-direction:row">
                <?php
                // Câu truy vấn để đếm tổng số nhà sản xuất
                $sql = "SELECT count(maNhaSanXuat) FROM nhasanxuat";
                ...
                $totalManufacturers = (int)$sl[0];
                $limit = 5; // Số lượng nhà sản xuất hiển thị trên mỗi trang
                $max = ceil($totalManufacturers / $limit);
                ...
                for ($i = $start; $i <= $end; $i++) {
                ?>
                    <a href="./index.php?action=quanlynhasanxuat&query=no&page=<?php echo $i ?>"
