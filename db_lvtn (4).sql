...
('SP16', 'Chuột chơi game Dareu EM908 RGB', 380000, 97, 'Chuột chơi game Dareu EM908 RGB.jpg', 'Tình trạng: Mới - Kết nối: có dây, cổng kết nối chuẩn USB - Tương thích: Windows 10, Windows 7, Mac OS và các hệ điều hành cũ.', 'NSX09', 'LSP08'),
...
('SP38', 'Màn hình Samsung LU28R550UQEXXV', 5700000, 91, 'Màn hình Samsung LU28R550UQEXXV.jpg', 'Loại màn hình: Phẳng - Tỉ lệ: 16:9 - Kích thước: 28 inch - Tấm nền: IPS - Độ phân giải: UHD 4K (3840 x 2160) - Tốc độ làm mới: 60Hz - Thời gian đáp ứng: 4ms - Cổng kết nối: HDMI, Display Port - Phụ kiện: Cáp nguồn, Cáp HDMI', 'NSX05', 'LSP07'),
...
('SP41', 'Tai nghe MSI True Gaming Headset H991', 399000, 86, 'Tai nghe MSI True Gaming Headset H991.jpg', 'Kiểu tai nghe: Chụp đầu - Kêt nối: 3.5mm', 'NSX06', 'LSP10'),
